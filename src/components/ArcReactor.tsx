const ArcReactor = ({ size = 200, isActive = false }: { size?: number; isActive?: boolean }) => {
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
        ...
        {Array.from({ length: 72 }).map((_, i) => {
          ...
          return (
            <line
              ...
              stroke={`hsl(195 100% 60% / ${isMajor ? 0.7 : 0.2})`}
      ...
      {/* === LAYER 2: Second ring - thick bright band with bracket segments === */}
      <svg width={size} height={size} className="absolute animate-rotate-reverse" style={{ animationDuration: "25s" }}>
        <circle cx={c} cy={c} r={r * 0.82} fill="none" stroke="hsl(195 100% 55% / 0.15)" strokeWidth="6" />
        <circle cx={c} cy={c} r={r * 0.82} fill="none" stroke="hsl(195 100% 70% / 0.5)" strokeWidth="1.5" />
        ...
        {Array.from({ length: 3 }).map((_, i) => {
          ...
          return (
            <path
              ...
              fill="none"
              stroke="hsl(195 100% 75% / 0.35)"
              strokeWidth="4"
              strokeLinecap="round"
            />
          );
        })}
        {/* Yellow/amber accent dots on this ring */}
      ...
      <svg width={size} height={size} className="absolute animate-rotate-slow" style={{ animationDuration: "20s" }}>
        <circle cx={c} cy={c} r={r * 0.68} fill="none" stroke="hsl(195 100% 50% / 0.3)" strokeWidth="1" />
        ...
        {Array.from({ length: 48 }).map((_, i) => {
          ...
          return (
            <line
              ...
              stroke={`hsl(195 100% 60% / ${isMajor ? 0.6 : 0.2})`}
      ...
      <svg width={size} height={size} className="absolute animate-rotate-reverse" style={{ animationDuration: "15s" }}>
        ...
        <circle cx={c} cy={c} r={r * 0.52} fill="none" stroke="hsl(195 100% 85% / 0.1)" strokeWidth="5" />
        ...
        {Array.from({ length: 3 }).map((_, i) => {
          ...
          return (
            <path
              ...
              fill="none"
              stroke="hsl(195 100% 80% / 0.35)"
              strokeWidth="3"
              strokeLinecap="round"
            />
          );
        })}
        {/* Yellow accent dots on inner ring */}
