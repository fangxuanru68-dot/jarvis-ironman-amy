...
const WarModeOverlay = ({ isActive, onEnd }: WarModeOverlayProps) => {
    ...
    <div className="fixed inset-0 pointer-events-none z-[25]">
      ...
      {visible && (
        <div
          ...
          style={{
            // Position at roughly the right eye area of the camera view
            top: "28%",
            right: "32%",
            width: "160px",
            height: "160px",
        ...
        >
          ...
          >
            ...
            {/* Small arc segments */}
            <path
              d="M 100 55 A 45 45 0 0 1 140 85"
              fill="none"
              stroke="hsl(195 100% 50% / 0.6)"
              strokeWidth="2"
            />
            <path
              d="M 100 145 A 45 45 0 0 1 60 115"
              fill="none"
              stroke="hsl(195 100% 50% / 0.6)"
              strokeWidth="2"
            />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-1.5 h-1.5 rounded-full border border-primary/80" style={{ boxShadow: "0 0 8px hsl(195 100% 50% / 0.6)" }} />
          </div>
      ...
      {/* War mode indicator - top center */}
      <div className="absolute top-6 left-1/2 -translate-x-1/2 flex items-center gap-2">
        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
        <span className="font-orbitron text-[10px] tracking-[0.3em] text-red-400/80">WAR MODE ACTIVE</span>
        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
      </div>

      {/* Red tint border */}
      <div className="absolute inset-0 border-2 border-red-500/10 rounded-none" />
    </div>
  );
};
